...
public class MainController : MonoBehaviour
{
    ...
    public void CreateDecisionTree()
    {
       ...
       var choice2 = c1.AddSingleNextNode(new NodeRenderedContent("Go to sleep?", "Avatar"))
        ...
        var c22 = choice3.Item2.AddSingleNextNode(new NodeRenderedContent("Your habitat destroyed by giraffe activities. You saw your own herd dwindle in numbers, and the once-vibrant savannah became a barren wasteland. One day, eventually, you starve to die. BE 4: habitats destroyed", "Avatar"));
        ...
        var c1211 = choice6.Item1.AddSingleNextNode(new NodeRenderedContent("You are safe because the giraffes are too tall to enter the cave. While the inside of the cave is dark, you heard some familiar voices. It's human! You found a human community shelter! The people in this shelter are all very welcoming. You waited until you do not hear the poachers  anymore and then go back to happily bring all the remaining members of your herd to this cave. You can finally settle down. Though, there was a second when confusion passed through your mind. Somehow, you felt the poachers that day were intentionally leading you to enter this cave. But that could not be possible. Why would they do that? NE: SHELTER", "Avatar"));
        ...
        var c2121 = choice7.Item1.AddSingleNextNode(new NodeRenderedContent("You and your herd started to eat leaves from the trees. In the first few days, everything was fine. Over-browse from the same trees activate the trees defense mechanism and prompt increased production of tannins, which makes leaves bitter-tasting.", "Avatar"));
