...
public class MainController : MonoBehaviour
{
    ...
    public void CreateDecisionTree()
    {
        ...
        var choice1 = start11.AddSingleNextNode(new NodeRenderedContent("Leave to search for another habitat, or stay here?", "", "0-3", "Idle"))/*Avatar think*/
            .AddChoiceNodes(new NodeRenderedContent("Leave", "","",""), new NodeRenderedContent("Stay", "Savana", "", ""));/*Avatar walk*/
       ...
       var choice2 = c1.AddSingleNextNode(new NodeRenderedContent("Go to sleep?", "", "01-2", "Idle"))/*Avatar think*/
            .AddChoiceNodes(new NodeRenderedContent("Yes", "", "", ""), new NodeRenderedContent("No", "", "", ""));/*Avatar sit with eyes closed*/

        var choice3 = c2.AddSingleNextNode(new NodeRenderedContent("Go searching for food and water, or stay here?", "", "02-2", "Idle"))/*Avatar think*/
            .AddChoiceNodes(new NodeRenderedContent("Go", "", "", ""), new NodeRenderedContent("Stay", "DamagedHabitat", "", ""));/*Avatar walk*/



        var c11 = choice2.Item1.AddSingleNextNode(new NodeRenderedContent("The sound of gunshots rang out across the savannah. It's the poachers.", "GiraffeWithShotgun", "011-1", "Idle"))
            ...
            .AddSingleNextNode(new NodeRenderedContent("Unfortunately, you became the target of the poachers and died. However, the gunshots served as an alert for most of the others in your herd. They survived, and would continue their journey to search for shelter. \nBE 1: Die in sleep", "", "011-3", "Idle"));/*Avatar sit with eyes closed*/
        var c12 = choice2.Item2.AddSingleNextNode(new NodeRenderedContent("You remained on high alert, always scanning the horizon for any sign of danger. You knew that you had to be careful if your herd wanted to survive.", "", "012-1", "Idle"))/*Avatar sit*/
            .AddSingleNextNode(new NodeRenderedContent("Later this night, the sound of gunshots rang out across the savannah. You knew that the poachers had come and that they were after your herd.", "GiraffeWithShotgun", "012-2", "Idle"));
        ...
        var c22 = choice3.Item2.AddSingleNextNode(new NodeRenderedContent("Your habitat destroyed by giraffe activities. You saw your own herd dwindle in numbers, and the once-vibrant savannah became a barren wasteland.", "Wasteland", "022-1", "Idle"))
            .AddSingleNextNode(new NodeRenderedContent("One day, eventually, you starve to die. \nBE 4: habitats destroyed", "", "022-2", "Idle"));/*Avatar lying on stomach*/


        var choice4 = c12.AddSingleNextNode(new NodeRenderedContent("What do you do now?", "", "012-3", "Idle"))/*Avatar think*/
            .AddChoiceNodes(new NodeRenderedContent("Run", "", "", ""), new NodeRenderedContent("Fight", "", "", ""));/*Avatar run; fight*/

        var choice5 = c21.AddSingleNextNode(new NodeRenderedContent("What do you do now?", "", "021-2", "Idle"))/*Avatar think*/
            .AddChoiceNodes(new NodeRenderedContent("Eat and drink", "", "", ""), new NodeRenderedContent("Return to notify your herd", "", "", ""));/*Avatar eat or drink; walk*/



        var c121 = choice4.Item1.AddSingleNextNode(new NodeRenderedContent("You wake up your herd and start to run as fast as you could, trying to outrun the poachers' bullets. The poacher chase you but they are slow and tall meanwhile you're quick and small. In front there are 2 path.", "DivergingPath", "0121-1", "Idle"));
        var c122 = choice4.Item2.AddSingleNextNode(new NodeRenderedContent("You fight the poachers. Those giraffes headshot you and you die instantly. \nBE 2: Resistance", "", "0122-1", "Idle"));/*Avatar injured and die*/
        var c211 = choice5.Item1.AddSingleNextNode(new NodeRenderedContent("The night came and you got lost, unable to find your way back to the herd. You cannot protect yourself yet. You died of lion predation. \nBE 5: Out of the herd", "Lion", "0211-1", "Idle"));
        ...
        var choice6 = c121.AddSingleNextNode(new NodeRenderedContent("Where do you go?", "", "0121-2", "Idle"))/*Avatar think*/
            .AddChoiceNodes(new NodeRenderedContent("A cave", "Cave1", "", ""), new NodeRenderedContent("Keep going", "", "", ""));/*Avatar run*/

        var choice7 = c212.AddSingleNextNode(new NodeRenderedContent("What to do now?", "", "0212-2", "Idle"))/*Avatar think*/
            .AddChoiceNodes(new NodeRenderedContent("Eat", "", "", ""), new NodeRenderedContent("Drink", "", "", ""));/*Avatar eat; drink*/
        ...
        var c2121 = choice7.Item1.AddSingleNextNode(new NodeRenderedContent("You and your herd started to eat leaves from the trees.", "", "02121-1", "Idle"))/*Avatar eat*/
        ...
        var choice9 = c2121.AddSingleNextNode(new NodeRenderedContent("What to do now?", "", "02121-3", "Idle"))
            .AddChoiceNodes(new NodeRenderedContent("Continue to eat the bitter leaves", "", "", ""), new NodeRenderedContent("Leave to find another habitat", "", "", ""));
        ...
        var c21211 = choice9.Item1.AddSingleNextNode(new NodeRenderedContent("Increased production of tannins in these leaves inhibit your ability to digest food. Poor digestion causes you and your herd in poor health condition.", "", "021211-1", "Idle"))/*Avatar feeling uncomfortable*/
            .AddSingleNextNode(new NodeRenderedContent("One day, you died of lion predation, and the remaining members of your herd will continue their journey to search for a shelter. \nBE 7: Overbrowsing", "Lion", "021211-2", "Idle"));
        var c21212 = choice9.Item2.AddSingleNextNode(new NodeRenderedContent("You and your herd encountered poachers on the way.", "GiraffeWithShotgun", "021212-1", "Idle"))
        ...
        c121222.AddSingleNextNode(new NodeRenderedContent("You barely escaped poachers, but your fellow humans weren't as lucky. Their lives were cut short by giraffe greed. Over time, more and more humans disappeared, and the once-vibrant savannah became barren.", "DamagedHabitat", "0121222-2", "Idle"))
            ...
            .AddSingleNextNode(new NodeRenderedContent("Despite the conservationists' best efforts, you passed away. Your legacy lived on through those who survived and found refuge.", "", "0121222-4", "Idle"))/*Avatar sit with eyes closed*/
            .AddSingleNextNode(new NodeRenderedContent("True Ending: No Regrets", "", "", "Idle"));
