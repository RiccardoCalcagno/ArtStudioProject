    ...
    public void CreateDecisionTree()
    {
       ...
       var choice2 = c1.AddSingleNextNode(new NodeRenderedContent("Go to sleep?", "DivergingPath", "01-2", "Thinking"))/*Avatar think*/
        ...
        var c22 = choice3.Item2.AddSingleNextNode(new NodeRenderedContent("Your habitat destroyed by giraffe activities. You saw your own herd dwindle in numbers, and the once-vibrant savannah became a barren wasteland.", "Wasteland", "022-1", "Sad Idle"))
            .AddSingleNextNode(new NodeRenderedContent("One day, eventually, you starve to die.", "Wasteland", "022-2", "Die 1"));/*Avatar lying on stomach*/
        ...
        var c122 = choice4.Item2.AddSingleNextNode(new NodeRenderedContent("You fight the poachers. Those giraffes headshot you and you die instantly.", "GiraffeWithShotgun", "0122-1", "Die 2"));/*Avatar injured and die*/
        var c211 = choice5.Item1.AddSingleNextNode(new NodeRenderedContent("The night came and you got lost, unable to find your way back to the herd. You cannot protect yourself yet. You died of lion predation.", "Lion", "0211-1", "Die 3"));
        ...
        var c1211 = choice6.Item1.AddSingleNextNode(new NodeRenderedContent("You found refuge in the cave because the giraffes couldn't enter due to their height. As you ventured deeper into the darkness, you heard the voices of fellow humans. Relief flooded over you as you discovered a human community shelter.", "CaveWithHumans", "01211-1", "Idle"))/*A group of people?*/
            ...
            .AddSingleNextNode(new NodeRenderedContent("Though, there was a second when confusion passed through your mind. Somehow, you felt the poachers that day were intentionally leading you to enter this cave. But that could not be possible. Why would they do that?", "MultiplePoachers", "01211-4", "Observe"));/*Avatar sit with eyes closed*/
        ...
        var c2122 = choice7.Item2.AddSingleNextNode(new NodeRenderedContent("You and your herd enjoyed the water from the river. A few moments later, you started to feel sick, so did most of people in your herd.", "DrinkingFromRiver", "02122-1", "Idle"))/*Avatar feeling uncomfortable*/
            ...
            .AddSingleNextNode(new NodeRenderedContent("You died of polluted water.", "Wasteland", "02122-3", "Die 4"));/*Avatar feeling uncomfortable*/
        ...
        var c21211 = choice9.Item1.AddSingleNextNode(new NodeRenderedContent("Increased production of tannins in these leaves inhibit your ability to digest food. Poor digestion causes you and your herd in poor health condition.", "Leaves", "021211-1", "Idle"))/*Avatar feeling uncomfortable*/
            .AddSingleNextNode(new NodeRenderedContent("One day, you died of lion predation, and the remaining members of your herd will continue their journey to search for a shelter.", "Lion", "021211-2", "Die"));
        var c21212 = choice9.Item2.AddSingleNextNode(new NodeRenderedContent("You and your herd encountered poachers on the way.", "GiraffesInTrucks", "021212-1", "Surprised"))
            ...
            .AddSingleNextNode(new NodeRenderedContent("You tried to run, but the shortage of food and water left you with limited energy to do that. You died. ", "", "021212-3", "Die 1"));/*Avatar die*/
        ...
        var c121221 = choice10.Item1.AddSingleNextNode(new NodeRenderedContent("Stay low. you are surrounded by giraffes and they capture you.", "MultiplePoachers", "0121221-1", "Die 2"));
        ...
        c121222.AddSingleNextNode(new NodeRenderedContent("You barely escaped poachers, but your fellow humans weren't as lucky. Their lives were cut short by giraffe greed. Over time, more and more humans disappeared, and the once-vibrant savannah became barren.", "DamagedHabitat", "0121222-2", "Idle"))
            ...
            .AddSingleNextNode(new NodeRenderedContent("True Ending: No Regrets", "Savana", "", "Victory"));
